...
public class CplexLPCloudletPlacement {
	 ...
	 */
	public int[] cplexModel(ArrayList<Cloudlet> C, ArrayList<CandidatePoint> P , 
		...
		try {
			...
			if(isSolved) {
				...
				return_vals[0] = (int) Math.ceil(objValue);
				...
				return_vals[1] = (int) Math.ceil(counter);
				/*System.out.print("\nDevice Assignments\n");
				for(int i = 0; i < v; i++) {
					for(int k=0; k < n; k++) {
	...
	/*public static void main(String[] args){
		...
		System.out.println("Objective value: " + results[0] + " " + "Cloudlets deployed: " + results[1]);
