...
public class ReadCSV {
    ...
    public int[][] getCloudlets(int num_cloudlets) {
    	...
    	String csvFile = "data-files/east_harlem/east_cloudlet.csv";
        String line = "";
        String cvsSplitBy = ",";
    ...
    public int[][] getDevices(int num_devices) {
    	...
    	String csvFile = "data-files/east_harlem/east_device.csv";
        String line = "";
        String cvsSplitBy = ",";
    ...
    public int[][] getCosts(int num_cloudlets, int num_candidates) {
    	...
    	String csvFile = "data-files/east_harlem/east_costs_20.csv";
        String line = "";
        String cvsSplitBy = ",";
    ...
    public int[][] getLatencies(int num_devices, int num_candidates) {
    	...
    	String csvFile = "data-files/east_harlem/east_latencies_20.csv";
        String line = "";
        String cvsSplitBy = ",";
